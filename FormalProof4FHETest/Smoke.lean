...
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSparseRankChannel.card_primitiveDifference_binaryQuotient_range
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSparseRankChannel.primitiveDifferenceBinaryRangeEquiv
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSparseRankChannel.exact_encodedPrimitiveExponentRank_count_eq_syndrome_count_sub_succ
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSparseRankChannel.encodedPrimitiveExponentRankCountExecutable
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSparseRankChannel.encodedPrimitiveExponentRankCountExecutable_eq
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSparseRankChannel.encodedPrimitiveExponentRankCountExecutable_degreeTwo_weightOne
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSparseRankChannel.average_finiteCoordinateOverlap_le_jointEnumerator
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSparseRankChannel.card_binaryQuotient_principalCokernel_eq_two_pow_hasseValuation
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSparseRankChannel.rightMul_affine_uniform_on_principalRange
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSparseRankChannel.principalRangeTimesCokernel_uniform
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSparseRankChannel.no_fixedCokernelCard_of_distinct_valuations

#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmith.quotientPowerOfTwo_twoPrimary_valuation
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmith.card_quotientPowerOfTwo_twoPrimary_range_eq_layered
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmith.card_quotientPowerOfTwo_twoPrimary_cokernel
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmith.quotientPowerOfTwo_twoPrimaryRangeEquiv
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmith.binaryWord_mem_adicPower_iff_executableHasseChecks
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmith.hasseInformationProjection_bijective
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmith.sum_pow_card_wordSupport_hasseDualWord_le
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmith.iidHasseEnumerator_le_twoLevelProduct
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmith.finite_maskedErrorCollisionMass_eq
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmith.average_pairKernel_le_twoLevelJointEnumerator
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmith.quotientErrorPair_annihilator_fourier_identity

#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmithExact.differenceParityBias_mem_unitInterval
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmithExact.hasseKernelMass_eq_weightEnumerator
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmithExact.exactNormalizedLocalFactor_eq
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmithExact.exactNormalizedLocalFactor_le_twoLevelProduct
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmithExact.lucasHasseWeightEvaluator_real_eq
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmithExact.card_supportChangingHistogramModel
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmithExact.card_sameSupportHistogramModel
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmithExact.quotientPowerOfTwo_completeDescriptor_valuation
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmithExact.exactRowFactorFromValuation_eq
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmithExact.jointTupleAggregation
#check FormalProof4FHE.RLWE.RankOneHNFLossinessTwoSmithExact.conditionalRowLocalAggregation
...
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.ExactMapReduction.advantage_pullback
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.ApproximateReduction.advantage_le
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.discriminantBadLoss_le
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.correctedTheorem5_advantage_le
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.correctedTheorem5_hardAgainst
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.correctedTheorem19_sameSample_hardAgainst
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.forwardSecret_quadratic
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.forward_hint_secret_gap_isUnit
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.forwardTransform_cannot_reach_zero_hint_secret
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.inverseTransformSecret_idempotent
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.smallSecretTransform_real_hint
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.shiftQuadraticHintView_real_hint
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.realShiftCoins_uniform_evalDist
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.binaryVectorXor_uniform_evalDist
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.xor_rerandomize_sample
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.exists_adjacent_gap_ge_average
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.CorrectedSearchToDecisionCertificate
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.quarter_success_bias
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.nonzeroCoordinatesProbability_ge_quarter
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.Regular.hint_equation
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.Regular.hint_gap_isUnit
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.Regular.discriminantRoot_isUnit
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.Regular.CoordinateSquareRoot
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.Regular.regularSignedRootSampler
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.Regular.signedRoot_isUnit
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.Regular.normalizedSignedRootSampler_uniform_evalDist
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.Regular.inverseBatchMap_uniform_evalDist
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.Regular.forwardCoinsMap_uniform_evalDist
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.Regular.forwardRealPublicMap_uniform_evalDist
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.Regular.forwardRandomPublicMap_uniform_evalDist
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.Regular.smallSecretTransform_preserves_regular
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.Regular.theorem5_regular_hardAgainst
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.Regular.theorem10_regular_hardAgainst
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.Regular.theorem19_regular_sameSample_hardAgainst
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.AutomorphismTransposition.weightedTransposition_decomposition
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.AutomorphismTransposition.no_diagonal_translation
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.AutomorphismTransposition.xorView_real
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.AutomorphismTransposition.xorView_uniform_evalDist
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.AutomorphismTransposition.xorView_splitChannel_evalDist
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.AutomorphismTransposition.insertionGap_eq_mean_sub_correlation
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.AutomorphismTransposition.insertedCorrelation_eq_two_parities
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.AutomorphismTransposition.abs_correlation_le_sqrt_two_mul
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.AutomorphismTransposition.ParityHidingCertificate.abs_correlation_le
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.AutomorphismTransposition.actualParityHiding_advantage_eq_sq_div_two
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.AutomorphismTransposition.splitParityHiding_advantage_eq_sq_div_two
#check FormalProof4FHE.RLWE.BinaryNTTSecurity.AutomorphismTransposition.transposition_gap_le
...
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.weightedSpanningTreeGuessingBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.weightedEdgeL1_le_priorDiff_add_tv
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.uniformSpanningTreeGuessingBound_of_edgeTV
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.descriptorAveragedLocalGuessingBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.card_fullTernarySecret
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.card_fixedWeightTernarySecret
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.quadraticCodewordRow_sub_factor
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.finiteIntervalGuessingCertificate
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.conditionalGuessingProbability_postprocessJoint_le
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.covarianceDominatedGaussianLossiness
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.probOutput_coherentLiftChannel
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.channelMaximalLeakageMass_coherentLiftChannel
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.boundedShiftedResidueEncoder_injective
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.tvDist_crtRecombination
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.crtRecombinedWeightedTreeGuessingBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.iidTernaryTensor_pushforward
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.fixedWeightTernaryTensor_pushforward
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.ExactTernaryMomentCertificate.codebookCovariance_eq
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.leakageAveragedGaussianFanoBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessSupportAware.canonicalRatioBlockSingularValueSquared_eq_completeRowEnergy
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.conditionalRenyiGuessingBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.finiteRenyiMoment_product
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.conditionalRenyiProductGuessingBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.conditionalRenyiProductEnergyEntropyBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.conditionalRenyiProductSubgaussianBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.renyiSlack_mul_le_half
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.conditionalRenyiProductExplicitBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.conditionalRenyiProductExplicitBound_renyiSlack
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.conditionalRenyiProductConditionedSubgaussianBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.abs_energy_sub_le_coordinateOscillation
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.quadraticSquare_update
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.codebookEnergy_change_le
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.descriptorBadSetExponentialGuessingBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.conditionalRenyiProductGuessingBound_coherentRows
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.EqualCovarianceGaussianRowCertificate.toRenyiRowEnergy
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRenyi.conditionalRenyiProductLaplaceThetaBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessMixtureRenyi.conditionalGuessingProbability_le_optimizedRenyiOverlap
#check FormalProof4FHE.RLWE.RankOneHNFLossinessMixtureRenyi.renyiCenter_root_eq_and_le
#check FormalProof4FHE.RLWE.RankOneHNFLossinessMixtureRenyi.conditionalGuessingProbability_le_expectedPosteriorNorm
#check FormalProof4FHE.RLWE.RankOneHNFLossinessMixtureRenyi.conditionalGuessingProbability_le_sqrt_posteriorCollision
#check FormalProof4FHE.RLWE.RankOneHNFLossinessMixtureRenyi.expectedPosteriorNorm_eq_priorNorm_of_posterior_eq
#check FormalProof4FHE.RLWE.RankOneHNFLossinessMixtureRenyi.expectedPosteriorAlphaMoment_eq_one_of_pointMass
#check FormalProof4FHE.RLWE.RankOneHNFLossinessMixtureRenyi.exp_neg_relativeEntropy_add_expectation_le_mixture
#check FormalProof4FHE.RLWE.RankOneHNFLossinessMixtureRenyi.EqualCovarianceGaussianMixtureCertificate.moment_le_localCluster
#check FormalProof4FHE.RLWE.RankOneHNFLossinessMixtureRenyi.conditionalGaussianMixtureClusterGuessingBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessMixtureRenyi.uniformGaussianMixtureClusterExponentialBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessMixtureRenyi.descriptorAveragedGaussianMixtureClusterGuessingBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessMixtureRenyi.normalizedPositiveWeight_alphaMoment
#check FormalProof4FHE.RLWE.RankOneHNFLossinessGaussianCluster.finiteRelativeEntropy_nonneg
#check FormalProof4FHE.RLWE.RankOneHNFLossinessGaussianCluster.finiteRelativeEntropy_add_average_eq_soft
#check FormalProof4FHE.RLWE.RankOneHNFLossinessGaussianCluster.clusterObjective_sub_dual_eq_gap
#check FormalProof4FHE.RLWE.RankOneHNFLossinessGaussianCluster.ClusterOptimalityCertificate.objective_le
#check FormalProof4FHE.RLWE.RankOneHNFLossinessGaussianCluster.EqualCovarianceGaussianMixtureCertificate.moment_le_softOverlap
#check FormalProof4FHE.RLWE.RankOneHNFLossinessGaussianCluster.conditionalGaussianMixtureEffectiveOverlapGuessingBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessGaussianCluster.effectiveOverlapMoment_le_bad_add_exp
#check FormalProof4FHE.RLWE.RankOneHNFLossinessGaussianCluster.conditionalGaussianMixtureEffectiveOverlapBadSetBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessGaussianCluster.log_finiteRenyiMoment_le_nonGaussianCluster
#check FormalProof4FHE.RLWE.RankOneHNFLossinessGaussianCluster.truncationMixtureGuessingBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessGaussianCluster.truncatedGaussianMixtureEffectiveOverlapGuessingBound
#check FormalProof4FHE.RLWE.RankOneHNFLossinessGaussianCluster.embeddedQuadraticDifferenceEnergy_eq_factorized
#check FormalProof4FHE.RLWE.TFHEppLvl5BootGaussianClusterScreen.two_pow_128_lt_radiusTwoOrbitCard
#check FormalProof4FHE.RLWE.TFHEppLvl5BootGaussianClusterScreen.radiusTwoGaussianMarkovUpper_lt
#check FormalProof4FHE.RLWE.TFHEppLvl5BootGaussianClusterScreen.radiusTwoImplementedChannelUnionUpper_lt
#check FormalProof4FHE.RLWE.TFHEppLvl5BootGaussianClusterScreen.radiusTwoGoodMask_no_128bit_certificate
#check FormalProof4FHE.RLWE.TFHEppLvl5BootGaussianClusterScreen.lvl5SignedNoise_translatedSupport_disjoint
#check FormalProof4FHE.RLWE.TFHEppLvl5BootTwoSmithScreen.overlapMasks_count_eq
#check FormalProof4FHE.RLWE.TFHEppLvl5BootTwoSmithScreen.anyOverlapMasks_mass_le
#check FormalProof4FHE.RLWE.TFHEppLvl5BootTwoSmithScreen.iidInformationSetFactor_eq
#check FormalProof4FHE.RLWE.TFHEppLvl5BootTwoSmithScreen.lvl5_completeCodebook_uniformMaskOverlap_strong_lt
#check FormalProof4FHE.RLWE.TFHEppLvl5BootTwoSmithScreen.lvl5_literalSecretDifference_image_lower
#check FormalProof4FHE.RLWE.TFHEppLvl5BootTwoSmithScreen.card_lvl5ErrorDifferenceBox_lt
#check FormalProof4FHE.RLWE.TFHEppLvl5BootTwoSmithScreen.lvl5FirstUnscreenedDescriptorOrder_decompose
#check FormalProof4FHE.RLWE.TFHEppLvl5BootTwoSmithScreen.lvl5_literalCompleteCodebookOverlap_lt
#check FormalProof4FHE.RLWE.TFHEppLvl5BootRenyiObstruction.lvl5SecretSupportCard_lt_two_pow
#check FormalProof4FHE.RLWE.TFHEppLvl5BootRenyiObstruction.lvl5SquareSecondMoment_formula
#check FormalProof4FHE.RLWE.TFHEppLvl5BootRenyiObstruction.lvl5_firstOrderRenyiMargin_not_pos
#check FormalProof4FHE.TFHE.Gadget.Base.finBalancedDigitEquiv
#check FormalProof4FHE.TFHE.Gadget.Base.balancedRowsEquiv
#check FormalProof4FHE.RLWE.TFHEppLvl5BootRepresentation.lvl5DoubleDecompositionEquiv
#check FormalProof4FHE.RLWE.TFHEppLvl5BootRepresentation.conditionalGuessingProbability_map_lvl5EncodedRows
#check FormalProof4FHE.RLWE.TFHEppLvl5BootRepresentation.finiteRenyiMoment_lvl5Representation
#check FormalProof4FHE.RLWE.TFHEppLvl5BootRepresentation.idealDigitFFTEncoding
#check FormalProof4FHE.RLWE.TFHEppLvl5BootRepresentation.lvl5_firstOrderRenyiMargin_after_roundTrip_not_pos
...
#check FormalProof4FHE.TFHE.Native.BlockBinarySelfCircular.packedRingSecret
#check FormalProof4FHE.TFHE.Native.BlockBinarySelfCircular.embedBits_mul_eq_zero_of_same_block
#check FormalProof4FHE.TFHE.Native.BlockBinarySelfCircular.squareFreeCrossAtDegree_packed_eq_crossBlockCross
#check FormalProof4FHE.TFHE.Native.BlockBinarySelfCircular.gadgetPhase_packed_eq_splitPhase
#check FormalProof4FHE.TFHE.Native.BlockBinarySelfCircular.generateBootstrappingKey_evalDist_eq_split
#check FormalProof4FHE.TFHE.Native.BlockBinarySelfCircular.realView_evalDist_eq_splitView
#check FormalProof4FHE.TFHE.Native.BlockBinarySelfCircular.oneCircularAdvantage_le_crossBlock_add_diagonal
#check FormalProof4FHE.TFHE.Native.BlockBinarySelfCircular.oneCircularHardAgainst_of_crossBlock_and_diagonal
#check FormalProof4FHE.TFHE.Native.BlockBinarySelfCircular.realGame_advantage_le_crossBlock_add_diagonal_add_zeroEndpoint
#check FormalProof4FHE.TFHE.Native.BlockBinarySelfCircular.pairedBits_implementationKeyEquiv
#check FormalProof4FHE.TFHE.Native.BlockBinarySelfCircular.implementationKey_uniform_evalDist
...
-- Coefficient-dependent RGSW circular security and its exact ordinary-RLWE reduction.
#check FormalProof4FHE.TFHE.RGSWCoefficientCircularSecurity.halfRenyiConcentration_uniform_bool
#check FormalProof4FHE.TFHE.RGSWCoefficientCircularSecurity.halfRenyiConcentration_uniform_ternary
#check FormalProof4FHE.TFHE.RGSWCoefficientCircularSecurity.leakedAdvantage_sq_le_two_mul_gamma_mul_removal
#check FormalProof4FHE.TFHE.RGSWCoefficientCircularSecurity.leakageGamma_eq_halfRenyiConcentration_of_optimizedLaw
#check FormalProof4FHE.TFHE.RGSWCoefficientCircularSecurity.rgswKDMAdvantage_le_sqrt_concentration_add_zero
#check FormalProof4FHE.TFHE.RGSWCoefficientCircularSecurity.rgswFamilyKDMAdvantage_le_sqrt_concentration_add_zero
#check FormalProof4FHE.TFHE.RGSWCoefficientCircularSecurity.nativeBinaryCoefficient_rgswKDMAdvantage_le
#check FormalProof4FHE.TFHE.RGSWCoefficientCircularSecurity.nativeTernaryCoefficient_rgswKDMAdvantage_le
#check FormalProof4FHE.TFHE.RGSWCoefficientCircularSecurity.rgswLeakageRemovalAdvantage_eq_batchRLWE
#check FormalProof4FHE.TFHE.RGSWCoefficientCircularSecurity.rgswZeroAdvantage_eq_batchRLWE
#check FormalProof4FHE.TFHE.RGSWCoefficientCircularSecurity.rgswKDMAdvantage_le_sqrt_card_add_batchRLWE
...
#check FormalProof4FHE.TFHE.JointSubsetKeyBRK.prefixRandomPart_comp_suffixEmbedding
#check FormalProof4FHE.TFHE.JointSubsetKeyBRK.prefixRandomPart_comp_prefixEmbedding
#check FormalProof4FHE.TFHE.JointSubsetKeyBRK.Factorization.apply_real
#check FormalProof4FHE.TFHE.JointSubsetKeyBRK.Factorization.ker_source_le_ker_gadget
#check FormalProof4FHE.TFHE.JointSubsetKeyBRK.simulatedKSKValue_real
#check FormalProof4FHE.TFHE.JointSubsetKeyBRK.tvDist_simulated_target_le_noise_add_failure
#check FormalProof4FHE.TFHE.JointSubsetKeyBRK.DefectCertificate.targetAdvantage_le_two_source_add_joint_errors
#check FormalProof4FHE.TFHE.JointSubsetKeyBRK.exists_factorization_of_rank_eq_width
#check FormalProof4FHE.TFHE.JointSubsetKeyBRK.factorizationFailure_le_rankFailure
#check FormalProof4FHE.TFHE.JointSubsetKeyBRK.factorizationFailure_le

-- Correction-noise, approximate-factorization, counting, and local-ring refinements.
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKRefined.ApproximateFactorization.apply_real
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKRefined.ApproximateFactorization.correctedKSKValue_real
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKRefined.ExactCorrectionNoiseCertificate.tvDist_assembled_eq_zero
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKRefined.GaussianCovarianceCompletionCertificate.covariance_eq
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKRefined.tvDist_mixture_le_half_sqrt_expectedEnergy
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKRefined.expectation_iidTernaryResidualEnergy_eq
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKRefined.targetAdvantage_le_mahalanobis
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKRefined.shortFactorizationSuccess_le_card_pow
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKRefined.shortFactorizationSuccess_le_primitive_filter
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKRefined.zmodPowerOfTwo_exists_linearMap_factorization_of_binary_rank
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKRefined.zmodPowerOfTwo_factorizationFailure_le_binaryRankFailure
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKRefined.zmodPowerOfTwo_factorizationFailure_le

-- Centered-mixture cancellation, fixed-weight ternary moments, and covariance matching.
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKCenteredMixture.CenteredMixtureChiSquareCertificate.pearsonChiSquare_eq_remainder
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKCenteredMixture.CenteredMixtureChiSquareCertificate.pearsonChiSquare_le_pairSecondMoment
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKCenteredMixture.CenteredMixtureChiSquareCertificate.tvDist_le_pairSecondMoment
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKCenteredMixture.targetAdvantage_le_centeredMixture
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKCenteredMixture.pairExpectation_sq_iidTernaryBilinearInteraction_eq
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKCenteredMixture.card_support_fixedWeightTernaryValue
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKCenteredMixture.secondMoment_fixedWeightTernaryWeightedSum_eq
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKCenteredMixture.pairExpectation_sq_fixedWeightTernaryBilinearInteraction_eq
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKCenteredMixture.CenteredMixtureChiSquareCertificate.tvDist_fixedWeightTernary_le
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKCenteredMixture.residualCovariance_posSemidef
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKCenteredMixture.transformed_add_matchedCorrection_add_residualCovariance
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKCenteredMixture.CovarianceMatchedCenteredMixtureCertificate.tvDist_le
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKCenteredMixture.CovarianceMatchedCenteredMixtureCertificate.covariance_eq

-- Necessary-condition screen for TFHEpp's standard subset-key dimensions.
#check FormalProof4FHE.TFHE.TFHEppSubsetJointScreen.covarianceBudget
#check FormalProof4FHE.TFHE.TFHEppSubsetJointScreen.covarianceRowEnergy_le_one
#check FormalProof4FHE.TFHE.TFHEppSubsetJointScreen.integralRowEnergy_le_one_eq_signedSingle
#check FormalProof4FHE.TFHE.TFHEppSubsetJointScreen.covarianceCompatibility_forces_signedSelectors
#check FormalProof4FHE.TFHE.TFHEppSubsetJointScreen.covarianceCompatibility_forces_zeroResidual
#check FormalProof4FHE.TFHE.TFHEppSubsetJointScreen.Parameters.topRow_zeroPostprocess_rejects_covariance
#check FormalProof4FHE.TFHE.TFHEppSubsetJointScreen.iidTernaryInteraction_eq_zero_of_zero_residual
#check FormalProof4FHE.TFHE.TFHEppSubsetJointScreen.iidTernaryInteraction_small_of_zero_residual
#check FormalProof4FHE.TFHE.TFHEppSubsetJointScreen.signedSelectorFactorizationSuccess_le

-- Delayed large-modulus combination followed by one rounded projection.
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.TranslationProjection.coordinatewise
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.ScaledApproximateFactorization.apply_real
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.ScaledApproximateFactorization.project_real
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.TFHEpp.highWord32To16_scale_add
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.TFHEpp.roundedHighWord32To16_scale_add
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.transformed_add_delayedCorrection_add_residualCovariance
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.Counting.twoBudgetFactorizationSuccess_le_card_pow
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.Counting.tfheppTwoBudgetFactorizationSuccess_le
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.Counting.probEvent_rowCombination_eq_image
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.Counting.imageAwareTwoBudgetFactorizationSuccess_le
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.Counting.card_rowCombination_scaledPrimitive_pow_two_range
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.Counting.powerOfTwoStrataFactorizationSuccess_le
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.Counting.powerOfTwoStratumFactorizationSuccess_le_of_card_bounds
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.Counting.exists_powerOfTwoStratum
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.Counting.powerOfTwoRowValuation_minimal
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.Counting.card_rowCombination_range_eq_powerOfTwoRowValuation
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.Counting.automaticPowerOfTwoStrataFactorizationSuccess_le
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.FiniteError.projectedCorrectedRealSampler_evalDist_eq_map_jointError
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.FiniteError.projectedCorrectedReal_tvDist_prescribed_le_jointError
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.FiniteError.projectedCorrectedReal_evalDist_eq_prescribed_of_jointError
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.FiniteError.probOutput_roundedJointErrorSampler_eq_mass
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.FiniteError.roundedJointError_evalDist_eq_independent_iff_mass

-- Exact compatible-box count and disjoint-block delayed-projection solver.
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.CenteredIntervalCount.card_centeredInterval_filter_modEq
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.CenteredIntervalCount.card_centeredInterval_filter_modEq_le
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.CompatibleBox.card_compatibleResidualBox_eq_prod
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.CompatibleBox.card_compatibleResidualBox_le_pow
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.ExactCompatibleProbability.probEvent_powerOfTwoStratum_residualBox_eq
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.BlockMinorSolver.blockInversePostprocess_mul
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.PowerOfTwoMinor.exists_exact_publicBlockPostprocess_of_binary_rank
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.BlockRankProbability.powerOfTwoBlockSolverFailure_le
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.BlockNoise.blockInversePostprocess_rowEnergy_le
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.BlockNoise.abs_blockInversePostprocess_mulVec_le
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.BlockNoise.iidDerivedCovariance_blockInversePostprocess_offDiagonal
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.BlockNoise.iidDerivedCovariance_blockInversePostprocess_diagonal_le
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.BlockNoise.iidDerivedCovariance_blockInversePostprocess_psd_le
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.BlockNoise.iidDerivedCovariance_targetCorrection_posSemidef
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.CenteredBlockNoise.abs_centeredLift_apply_le_half
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.CenteredBlockNoise.abs_centeredBlockPostprocess_mulVec_le
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.CenteredBlockNoise.iidDerivedCovariance_centeredBlockPostprocess_psd_le
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.CenteredBlockNoise.iidDerivedCovariance_centeredBlockPostprocess_targetCorrection_posSemidef
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.ScaledRingSolver.scaledPublicBlockFactorization_project_real
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.FiniteError.projectedCorrectedReal_evalDist_eq_prescribed_derivedTargetError
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.SecurityBound.targetAdvantage_le_of_blockSolver_bounds
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.SecurityBound.targetAdvantage_le_of_blockSolver_exactDerivedLaw
#check FormalProof4FHE.TFHE.JointSubsetKeyBRKDelayedProjection.TFHEpp.scale16To32_mul_reduce32To16

#check FormalProof4FHE.TFHE.TFHEppSubsetTechnical.covarianceCorrection_not_posSemidef_of_narrowerTarget_integralRow
#check FormalProof4FHE.TFHE.TFHEppSubsetTechnical.Parameters.highModulusRadius_3104_fits
#check FormalProof4FHE.TFHE.TFHEppSubsetTechnical.Parameters.highModulusRadius_3105_fails
#check FormalProof4FHE.TFHE.TFHEppSubsetTechnical.Parameters.exactTargetRingFactorization_rejects_currentCovariance
#check FormalProof4FHE.TFHE.TFHEppSubsetTechnical.FullSecretKSK.dotProduct_combinedTargetRow_combinedSecret
#check FormalProof4FHE.TFHE.TFHEppSubsetTechnical.FullSecretKSK.fullSecretKSKBody_eq
#check FormalProof4FHE.TFHE.TFHEppSubsetTechnical.FullSecretKSK.productionCombinedDimension_eq
#check FormalProof4FHE.TFHE.TFHEppSubsetTechnical.ShortPreimageCapacity.suffixTernaryCandidates_capacity
#check FormalProof4FHE.TFHE.TFHEppSubsetTechnical.ShortPreimageCapacity.suffixTernaryCandidates_minimal
#check FormalProof4FHE.TFHE.TFHEppSubsetTechnical.ShortPreimageCapacity.suffixTernaryCandidates_energy_fits
#check FormalProof4FHE.TFHE.TFHEppSubsetTechnical.ShortPreimageCapacity.fullSecretTernaryCandidates_capacity
#check FormalProof4FHE.TFHE.TFHEppSubsetTechnical.ShortPreimageCapacity.fullSecretTernaryCandidates_minimal
#check FormalProof4FHE.TFHE.TFHEppSubsetTechnical.ShortPreimageCapacity.fullSecretTernaryCandidates_energy_fits

-- Cluster-aware ternary second moments, disjoint Gram control, and the SIS search boundary.
#check FormalProof4FHE.TFHE.TFHEShortPreimageSecondMoment.ClusteredMoment.sum_hitCount_eq
#check FormalProof4FHE.TFHE.TFHEShortPreimageSecondMoment.ClusteredMoment.sum_hitCount_sq_eq
#check FormalProof4FHE.TFHE.TFHEShortPreimageSecondMoment.ClusteredMoment.zeroHitSeedRatio_le
#check FormalProof4FHE.TFHE.TFHEShortPreimageSecondMoment.ClusteredMoment.someTargetZeroSeedRatio_le
#check FormalProof4FHE.TFHE.TFHEShortPreimageSecondMoment.DisjointGram.mul_transpose_eq_diagonal
#check FormalProof4FHE.TFHE.TFHEShortPreimageSecondMoment.DisjointGram.gram_psd_le
#check FormalProof4FHE.TFHE.TFHEShortPreimageSecondMoment.SISBoundary.geometricRelation_ne_zero
#check FormalProof4FHE.TFHE.TFHEShortPreimageSecondMoment.SISBoundary.geometricPreimages_give_sis
#check FormalProof4FHE.TFHE.TFHEShortPreimageSecondMoment.PairClassification.pairCombination_surjective_of_unit_minor
#check FormalProof4FHE.TFHE.TFHEShortPreimageSecondMoment.PairClassification.pairCombination_surjective_of_different_ternary_support
#check FormalProof4FHE.TFHE.TFHEShortPreimageSecondMoment.PairClassification.exists_unit_two_minor_of_same_support
#check FormalProof4FHE.TFHE.TFHEShortPreimageSecondMoment.PairClassification.scalarParity_reduceCoefficient_eq_of_same_support

-- Conditional NTRU lossy dual-mode composition for complete subset-key views.
#check FormalProof4FHE.LWE.AuxiliaryInput.SearchToDecision.HeterogeneousCrossReduction
#check FormalProof4FHE.LWE.AuxiliaryInput.SearchToDecision.publicHardAgainst_of_heterogeneousCrossReduction
#check FormalProof4FHE.RLWE.RankOneHNFLossinessRLWENTRU.SometimesLossyCertificate.bound_ne_top
#check FormalProof4FHE.TFHE.SubsetKeyNTRUDualMode.hnfRecovery_successProbability_eq
#check FormalProof4FHE.TFHE.SubsetKeyNTRUDualMode.publicAdvantage_le_hnf_add_reductionLoss
#check FormalProof4FHE.TFHE.SubsetKeyNTRUDualMode.kdmAdvantage_le_hnf_add_reductionLoss_add_zero
#check FormalProof4FHE.TFHE.SubsetKeyNTRUDualMode.kdmAdvantage_le_jointNTRU_add_reductionLoss_add_zero
#check FormalProof4FHE.TFHE.SubsetKeyNTRUDualMode.kdmAdvantage_le_maskedNTRU_add_reductionLoss_add_zero

-- Exact hidden-descriptor posterior identity and public affine-compiler boundary.
#check FormalProof4FHE.TFHE.SubsetKeyNTRUTrapdoor.revealedHNFObservationSampler_evalDist_eq_anchored
#check FormalProof4FHE.TFHE.SubsetKeyNTRUTrapdoor.conditionalGuessingProbability_revealedHNF_eq_averageLossiness
#check FormalProof4FHE.TFHE.SubsetKeyNTRUTrapdoor.guessingSuccess_revealedHNF_le_sometimesLossyBound
#check FormalProof4FHE.TFHE.SubsetKeyNTRUTrapdoor.coefficientRecoveryAdvantage_eq_abs_success_sub
#check FormalProof4FHE.TFHE.SubsetKeyNTRUTrapdoor.publicCoefficient_bind_evalDist_eq_of_projection_eq
#check FormalProof4FHE.TFHE.SubsetKeyNTRUTrapdoor.CoordinateRatioWitness.scale_bijective
#check FormalProof4FHE.TFHE.SubsetKeyNTRUTrapdoor.CoordinateRatioWitness.scale_coefficientChannel
#check FormalProof4FHE.TFHE.SubsetKeyNTRUTrapdoor.denominator_mul_maskedRatioChannel
#check FormalProof4FHE.TFHE.SubsetKeyNTRUTrapdoor.kdmAdvantage_le_hiddenNTRU_four_losses
#check FormalProof4FHE.TFHE.SubsetKeyNTRUTrapdoor.affineNoiselessCorrect_iff_offsets_eq_and_factorization
#check FormalProof4FHE.TFHE.SubsetKeyNTRUTrapdoor.factorizationOfAffineNoiselessCorrect

-- Consolidated trapdoor, built-in-preimage, and source-aligned subset-key theorems.
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.publicBranchConstructorReduction
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.witnessJointSampler_publicMarginal_eq_uniform
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.reconstructionSuccess_ge_one_sub
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.affineFactorizationNecessity
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.affineCompilerDerivedError
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.taggedMask_add_trapdoor_comp_source
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.taggedPhase
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.nativeSuffixMaskErasureNecessity
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.taggedExactCorrection_jointLaw
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.taggedJointSecurity
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.primitiveDerivedError_close_to_idealUniform
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.projectedSolverCorrectness_le
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.BuiltInPreimage.sampler_tvDist_ideal_le
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.BuiltInPreimage.samplerBlocks_tvDist_ideal_le
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.BuiltInPreimage.samplerIID_tvDist_ideal_le
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.BuiltInPreimage.realPreimage_weightedEnergy
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.BuiltInPreimage.blockPreimage_mul_transpose_eq
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.SourceAligned.FactorCiphertext.keySwitch_phase
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.SourceAligned.FactorCiphertext.phase_add
#check FormalProof4FHE.TFHE.SubsetKeyTrapdoorTheorems.SourceAligned.FactorCiphertext.phase_scale
...
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.externalProduct_phase
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.cmux_factor
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.cmux_phase
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.run_factor
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Native.rotate_factor
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Native.rotate_phase
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Native.blindRotationStep_eq_add_externalProduct
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Native.blindRotationRun_eq_runCMUX
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Native.nativeBlindRotate_eq_runCMUX
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Extraction.suffixMask_apply
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Extraction.dotProduct_extractedSecret_extractVector
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Extraction.phase_apply
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Energy.factorEnergy_add_eq
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Energy.factorEnergy_linearCombination_le
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Energy.factorEnergy_cmux_eq
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Energy.factorEnergy_cmux_le
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Energy.factorEnergy_run_le_traceBound

-- Concrete source-aligned ring/scalar gadgets and native BRK row alignment.
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Extraction.extractVectorAddEquiv
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Extraction.inducedScalarGadget_mulVec
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Extraction.inducedScalarGadget_compatible
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.Extraction.keySwitch_after_apply_phase
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.ColumnAlignment.columnGadget_mulVec_unitFactor
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.ColumnAlignment.linearCombination_alignedRow_factor
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.ColumnAlignment.factorEnergy_linearCombination_alignedRow
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.NativeAlignment.commonScalarGadget_compatible
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.NativeAlignment.alignedControlRow_materialize
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.NativeAlignment.linearCombination_alignedControlRow_factor
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.NativeAlignment.factorEnergy_controlFactor
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.NativeAlignment.sum_controlFactor_eq_traceFactor
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.NativeAlignment.factorEnergy_sum_controlFactor
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.NativeAlignment.directEncrypt_mask_evalDist_eq_uniform
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.NativeAlignment.generateBootstrappingKey_mask_evalDist_eq_uniform
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.NativeAlignment.flattenMaskEquiv
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.NativeAlignment.flattenMask_uniform_evalDist
#check FormalProof4FHE.TFHE.SourceAlignedFactorPropagation.NativeAlignment.generateBootstrappingKey_commonRingGadget_evalDist_eq_uniform

-- Complete source-aligned BRK/KSK joint law and deterministic native-compiler barrier.
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.Algebra.inducedScalarGadget_transpose_mulVec
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.CompleteView.completeVectorSmudging_postprocess_le
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.CompleteView.targetAdvantage_le_two_sources_add_errors
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.CompleteView.alignedJointSecurity
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.CompleteView.alignedJointSecurity_le_hardness
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.CompleteView.alignedJointSecurity_correlated
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.NativeCompiler.tvDist_append_deterministic_le
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.NativeCompiler.tvDist_uniformFinset_uniform
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.NativeCompiler.tvDist_map_uniform_addHom_eq
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.NativeCompiler.compiledBody_eq_of_factorization
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.NativeCompiler.compiledBody_eq_with_residual
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.NativeCompiler.card_compiledMaskAddHom_range_eq_rowRange_pow
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.NativeCompiler.tvDist_compiledMask_uniform_eq_image_ratio
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.NativeCompiler.tvDist_compiledMask_zmod_uniform_ge_inv_width_gap
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.NativeCompiler.evalDist_compiledMask_zmod_ne_uniform
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.NativeCompiler.nativeGadget_mulVec_evaluatorResidual_eq_zero
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.NativeCompiler.evaluatorError_sub_eq
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.NativeCompiler.nativeGadget_mulVec_evaluatorResidual
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.NativeCompiler.EvaluatorTail.probEvent_ge_le_exp_mul_expectation
#check FormalProof4FHE.TFHE.SourceAlignedBRKKSKJointLaw.NativeCompiler.EvaluatorTail.Certificate.upperTail
...
#check FormalProof4FHE.TFHE.SourceAlignedProofErrorSampler.expectation_exp_pairDifference_le_sharp
#check FormalProof4FHE.TFHE.CenteredBinomialProofErrorSampler.expectation_exp_decodeReal_le
#check FormalProof4FHE.TFHE.CenteredBinomialProofErrorSampler.modularVectorSampler_eq_sampleIID
#check FormalProof4FHE.TFHE.CenteredBinomialProofErrorSampler.sphericalCertificate
...
#check FormalProof4FHE.RLWE.EvenOddDecomposition.joinRq_commRing_mul_even
#check FormalProof4FHE.RLWE.EvenSecretReduction.advantage_eq_smallRLWE
...
#check FormalProof4FHE.TFHE.SourceAlignedParityTernarySecurity.paritySuffixAdvantage_eq_smallTernaryRLWE
#check FormalProof4FHE.TFHE.SourceAlignedParityTernarySecurity.endpointAdvantage_le_hardness
#check FormalProof4FHE.TFHE.TFHEppCandidateLvl02CBDParameterScreen.modulus_eq
#check FormalProof4FHE.TFHE.TFHEppCandidateLvl02CBDParameterScreen.discardedBits_eq
#check FormalProof4FHE.TFHE.TFHEppCandidateLvl02CBDParameterScreen.alignedWidth_eq
#check FormalProof4FHE.TFHE.TFHEppCandidateLvl02CBDParameterScreen.cbd_noWrap
#check FormalProof4FHE.TFHE.TFHEppCandidateLvl02CBDParameterScreen.correctionSampler_eq_sampleIID
#check FormalProof4FHE.TFHE.TFHEppCandidateLvl02CBDParameterScreen.finiteSampler_adaptiveAbsTail
#check FormalProof4FHE.TFHE.TFHEppCandidateLvl02CBDParameterScreen.nominalFreshExponent_eq
#check FormalProof4FHE.TFHE.TFHEppCandidateLvl02CBDParameterScreen.nominalFreshTail_lt_two_pow_neg_226
#check FormalProof4FHE.TFHE.TFHEppCandidateLvl02CBDParameterScreen.finiteSampler_adaptiveAbsTail_lt_two_pow_neg_226
#check FormalProof4FHE.TFHE.TFHEppCandidateLvl02CBDParitySecurity.Parameters.smallRLWESampleCount_eq
#check FormalProof4FHE.TFHE.TFHEppCandidateLvl02CBDParitySecurity.Parameters.correctionSampler_eq_screen
#check FormalProof4FHE.TFHE.TFHEppCandidateLvl02CBDParitySecurity.endpointAdvantage_le_CBD_RLWE_and_CBD_LWE
#check FormalProof4FHE.TFHE.TFHEppCandidateLvl02CBDParitySecurity.endpointAdvantage_le_hardness

-- Exact streamed source-aligned correlated joint format.
#check FormalProof4FHE.TFHE.SourceAlignedExecutableJointFormat.sourceBodyFromBRK_real
#check FormalProof4FHE.TFHE.SourceAlignedExecutableJointFormat.reuseBRKAssemble_real_eq_assemble
#check FormalProof4FHE.TFHE.SourceAlignedExecutableJointFormat.reuseBRKAssemble_kskBody_eq_rowFormula
#check FormalProof4FHE.TFHE.SourceAlignedExecutableJointFormat.executableRealSampler_eq_view
#check FormalProof4FHE.TFHE.SourceAlignedExecutableJointFormat.CandidateCBD27.candidateExecutableRealSampler_eq_candidateReal
#check FormalProof4FHE.TFHE.SourceAlignedExecutableJointFormat.CandidateCBD27.literalKSKBytes_eq
...
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.AdaptiveFreshNoise.independentProduct
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.AdaptiveFreshNoise.covarianceEnergy_spherical
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.AdaptiveFreshNoise.exp_neg_sq_div_two_mono_variance
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.AdaptiveFreshNoise.Certificate.absTail_le_uniformVariance
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.AdaptiveFreshNoise.Certificate.adaptiveIndependentAbsTail
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.Parameters.brkRowCount_eq
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.Parameters.alignedWidth_eq
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.Parameters.factorEnergyBound_eq
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.Parameters.freshPairingVarianceBound_eq
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.Parameters.factorEnergy_le_bound
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.Parameters.nominalSphericalCovarianceEnergy_le
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.Parameters.nativeSubsetWidth_lt_alignedWidth
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.Parameters.nominalFreshExponent_eq

-- Balanced lvl02 candidate arithmetic.
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.CandidateLvl02.suffixDimension_eq
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.CandidateLvl02.decompositionCoverage_eq
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.CandidateLvl02.brkRowCount_eq
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.CandidateLvl02.alignedWidth_eq
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.CandidateLvl02.factorEnergyBound_eq
#check FormalProof4FHE.TFHE.TFHEppSourceAlignedParameterScreen.CandidateLvl02.freshSigma_eq
...
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.bodyRow_publicLinear
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.nonceRow_booleanPolynomial
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.no_separable_nonce_of_suffix_variation
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.no_affine_nonce_of_unit_cross_embedding
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.controlAndDisplayedNonceMask_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.rawMaskRecoverySuccess_le_half
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.nativeBRKNormalization
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.orbitFilteredCorrelation_eq_fourierCoefficient
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.diagonalFourierIdentity
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.lowFrequencyCount_eq_binomialLowFrequencyCount
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.finiteRangeLeakageRemoval_binaryBound
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.completeChannelPosteriorEnergy_formula
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.completeChannel_fourier_le_posteriorSpectralRadius
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.oneBitPoint_real_random_gap
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.oneBitPoint_predictor_success
#check FormalProof4FHE.TFHE.NativeTRGSWBarrierAndSpectralBoundary.completeChannel_conditionalNativeCircularSecurity

-- Actual shared-prefix/suffix native BRK+KSK channel.
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteChannel.supportLeakageRemoval_binaryBound
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteChannel.vecMul_add_gadgetPhase_add_error_eq_knownMessageAffine
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteChannel.normalizeKnownMessageDirectCiphertext_encrypt_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteChannel.affineNormalize_generateKnownMessageCloudKey_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteChannel.affineNormalize_fixedPrefixMessageView_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteChannel.LowDegreeAffineSourceCertificate.lowFrequencyBound
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteChannel.transform_fixedPrefixMessageView_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteChannel.diagonalNativeView_evalDist_eq_realCloudKeyView
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteChannel.realCloudKeyAcceptance_eq_diagonalMean
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteChannel.one_sub_two_mul_le_posteriorSpectralRadius_of_decoder
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteChannel.realCloudKey_conditionalNativeCircularSecurity

-- Native suffix-KSK recovery and statistical spectral infeasibility.
#check FormalProof4FHE.TFHE.NativeTRGSWSpectralInfeasibility.probEvent_wrongPrefix_candidateResidual_forall_mem_eq
#check FormalProof4FHE.TFHE.NativeTRGSWSpectralInfeasibility.probEvent_exhaustiveKSKDecoder_keyed_failure_le_zmod
#check FormalProof4FHE.TFHE.NativeTRGSWSpectralInfeasibility.probEvent_twoStageDecoder_failure_le_add
#check FormalProof4FHE.TFHE.NativeTRGSWSpectralInfeasibility.one_sub_two_mul_le_posteriorSpectralRadius_of_pairDecoder
#check FormalProof4FHE.TFHE.NativeTRGSWSpectralInfeasibility.binomial_spectralTail_lowerBound_of_pairDecoder
#check FormalProof4FHE.TFHE.NativeTRGSWSpectralInfeasibility.jointAffine_leakageRemoval_binaryBound
#check FormalProof4FHE.TFHE.NativeTRGSWSpectralInfeasibility.marginalCounterexample_first_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWSpectralInfeasibility.marginalCounterexample_second_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWSpectralInfeasibility.marginalCounterexample_decoder_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWSpectralInfeasibility.sampledKnownMessage_zero_endpoint_le_two_mul

-- Concrete TFHEpp lvl10 centered-ternary suffix separation and exhaustive recovery.
#check FormalProof4FHE.TFHE.NativeTRGSWConcreteSuffixSeparation.card_centeredBall_le
#check FormalProof4FHE.TFHE.NativeTRGSWConcreteSuffixSeparation.lvl10RowCount_eq
#check FormalProof4FHE.TFHE.NativeTRGSWConcreteSuffixSeparation.lvl10TopCode_centeredDistance_ge
#check FormalProof4FHE.TFHE.NativeTRGSWConcreteSuffixSeparation.lvl10SuffixSeparated_centeredBall
#check FormalProof4FHE.TFHE.NativeTRGSWConcreteSuffixSeparation.probEvent_lvl10_exhaustiveKSKDecoder_failure_le_explicit
#check FormalProof4FHE.TFHE.NativeTRGSWConcreteSuffixSeparation.probEvent_lvl10IIDError_not_typical_le
#check FormalProof4FHE.TFHE.NativeTRGSWConcreteSuffixSeparation.lvl10_radius127_falseCandidate_le_inv_twoPow
#check FormalProof4FHE.TFHE.NativeTRGSWConcreteSuffixSeparation.probEvent_lvl10_centeredBinomial_exhaustiveKSKDecoder_failure_le_inv_twoPow

-- Concrete native lvl01 correct-key BRK recovery with executable CBD noise.
#check FormalProof4FHE.TFHE.CenteredBinomialCorrectness.cInfNorm_rowError_le_eta_of_mem_support_encrypt
#check FormalProof4FHE.TFHE.NativeTRGSWConcreteBRKRecovery.constantCoefficient_lvl01Message_mul_topGadget
#check FormalProof4FHE.TFHE.NativeTRGSWConcreteBRKRecovery.lvl01BodySample_eq_code_add_rowError
#check FormalProof4FHE.TFHE.NativeTRGSWConcreteBRKRecovery.lvl01CodeDistance_eq
#check FormalProof4FHE.TFHE.NativeTRGSWConcreteBRKRecovery.decodeLvl01Entry_eq
#check FormalProof4FHE.TFHE.NativeTRGSWConcreteBRKRecovery.decodeLvl01BRK_eq_of_mem_support
#check FormalProof4FHE.TFHE.NativeTRGSWConcreteBRKRecovery.probEvent_decodeLvl01BRK_ne_eq_zero

-- Aggregate native high-pass game and full-key complexity leveraging.
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateSecurityAndComplexityLeveraging.walshTransform_highPassWeight
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateSecurityAndComplexityLeveraging.aggregateNormalization_bounds
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateSecurityAndComplexityLeveraging.aggregateWeight_walsh_gap
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateSecurityAndComplexityLeveraging.weightedOrbitMean_highPassWeight
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateSecurityAndComplexityLeveraging.aggregateAcceptance_true_sub_false
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateSecurityAndComplexityLeveraging.diagonalGap_le_lowCount_mul_add_aggregate
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateSecurityAndComplexityLeveraging.signGuessReduction_gap
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateSecurityAndComplexityLeveraging.pointOracle_aggregateGap_pos
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateSecurityAndComplexityLeveraging.fullKeyConcentration_le_leakageGamma
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateSecurityAndComplexityLeveraging.fullKeyAggregateAdvantage_le_sqrt_matchSquare
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateSecurityAndComplexityLeveraging.nativeAggregateGap_le_defects_add_sqrt
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateSecurityAndComplexityLeveraging.nativeCircularSecurity_with_complexityLeveraging
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateSecurityAndComplexityLeveraging.fullKeyConcentration_uniform_binary_ternary

-- Concrete native aggregate games and certified executable mask laws.
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateConcreteChannel.aggregateMaskPMF_apply_toReal
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateConcreteChannel.roundedAggregateMaskCertificate
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateConcreteChannel.certificate_sum_abs_probabilityMass_sub_target_le
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateConcreteChannel.aggregateOrbitExperiment_acceptance_eq_weightedOrbitMean
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateConcreteChannel.nativeAggregateView_acceptance_eq_weightedOrbitMean
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateConcreteChannel.nativeAggregateView_acceptance_eq_aggregateAcceptance_of_probabilityMass
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateConcreteChannel.nativeAggregateView_acceptance_sub_aggregateAcceptance_le_certificate
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateConcreteChannel.diagonalGap_le_low_add_approximateAggregate
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateConcreteChannel.nativeAggregateView_acceptance_gap_eq
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateConcreteChannel.realCloudKey_gap_le_low_add_nativeAggregate
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateConcreteChannel.realCloudKey_gap_le_low_add_certifiedNativeAggregate
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateConcreteChannel.realCloudKey_conditionalCertifiedAggregateSecurity

-- Projected leakage, exact norm, and the phase-oblivious aggregate stabilizer barrier.
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.addKnownGadgetToZeroRows
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.knownMessageTranslations_uniform_evalDist_eq
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.projectedAggregateAdvantage_le_sqrt_matchSquare
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.nativeProjectedAggregateGap_le_defects_add_sqrt
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.nativeAggregateGap_le_of_approximateErasure
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.diagonalFunctionalRatio_inverseWeightWitness_eq
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.diagonalFunctionalRatio_le_sum_div
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.halfRenyiConcentration_map_le
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.commonAggregateTranslationInvariant_iff_walsh_eq_one
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.commonAggregateTranslationInvariant_iff_evenWalshParity
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.commonAggregateTranslationInvariant_iff_eq_zero_of_degree_add_two_le
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.halfRenyiConcentration_fullWalshParityBit_uniform_eq_two
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.prefix_eq_of_equal_leakage_phaseOblivious
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.fullWalshParityBit_eq_of_equal_leakage_phaseOblivious
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.two_le_projectedLeakageConcentration_of_phaseOblivious_lastCutoff
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateProjectedLeakage.twoPow_card_le_projectedLeakageConcentration_of_phaseOblivious

-- Complete-view auxiliary zero-row source and prefix-only match-and-square loss.
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteViewAuxiliarySource.simulator_over_jointSource_evalDist_eq_targetView
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteViewAuxiliarySource.conditionalTwoCopySource
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteViewAuxiliarySource.auxiliaryInputZeroRowAdvantage_nonneg
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteViewAuxiliarySource.simulatedIndependentView_sign_erasure
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteViewAuxiliarySource.nativeKnownMessage_mapRows_exact
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteViewAuxiliarySource.nativeCompleteView_uniform_sign_erasure
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteViewAuxiliarySource.nativeCompleteView_conditionalUniform_sign_erasure
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteViewAuxiliarySource.completeViewPrefixConcentration_eq_of_prefixMarginal_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteViewAuxiliarySource.completeViewZeroRowReductionAdvantage_eq_half_guessedSecondMoment
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteViewAuxiliarySource.completeViewPrefixConcentration_uniform_binary
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteViewAuxiliarySource.nativeCompleteViewAggregateGap_le_prefixMarginal
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteViewAuxiliarySource.nativeCompleteViewAggregateGap_le_approximateErasure
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteViewAuxiliarySource.nativeCircularSecurity_with_completeViewPrefix
#check FormalProof4FHE.TFHE.NativeTRGSWCompleteViewAuxiliarySource.extractionBasedSourceAdvantage_lowerBound

-- Known-suffix prefix-RLWE discharge of the complete-view zero-row source.
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.addKnownSuffixBlock_real
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.addKnownSuffixBlock_uniform_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.negacyclicProduct_add_left
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.addKnownSuffixCoefficientBlock_real
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.addKnownSuffixCoefficientBlock_uniform_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.negacyclicProduct_prefix_apply_eq_dotProduct
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.prefixExtractedMask_uniform_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.extractedUniformKSKRow_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.extractKSKBatch_real
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.prefixRLWEProblem_uniformDistr_eq
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.knownSuffix_uniform_disjoint_branch_erasure
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.knownSuffix_uniform_disjointBlock_branch_erasure
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.ExactCVZRCompiler.targetAdvantage_le_two_source
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.ExactCVZRCompiler.reduction_advantage_eq_half_targetAdvantage
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.approximateCVZR_targetAdvantage_le
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.cvzrAdvantage_le_prefixRLWE
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.twoCopyCVZRAdvantage_le_prefixRLWE
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.completeViewZeroRowTargetAdvantage_eq
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.completeViewZeroRowReductionAdvantage_le_prefixRLWE
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRReduction.nativeCompleteViewAggregateGap_le_prefixRLWE

-- Concrete native coefficient/CBD instantiation of the CVZR compiler.
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRConcreteInstantiation.sourceIndexEquiv
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRConcreteInstantiation.selectedErrorVector_cbd_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRConcreteInstantiation.extractedNativeKSKSampler_evalDist_eq_generateKeySwitchKey
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRConcreteInstantiation.buildNativeZeroBRK_independent_uniform_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRConcreteInstantiation.extractedNativeZeroCloudKeySampler_evalDist_eq_generateBootstrapZeroCloudKey
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRConcreteInstantiation.nativeCVZRBuild_uniform_evalDist_eq
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRConcreteInstantiation.sourceAlignedNativeCVZRView_evalDist_eq_native
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRConcreteInstantiation.nativeCVZRAdvantage_le_two_prefixRLWE
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRConcreteInstantiation.nativeCVZR_reduction_advantage_eq_half

-- Parity-prefix CVZR discharge to ordinary half-degree binary RLWE.
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRParityPrefix.parityPrefixCoefficients_add_suffixCoefficients
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRParityPrefix.addParityKnownSuffixRow_real
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRParityPrefix.addParityKnownSuffixRow_uniform_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRParityPrefix.evenSecretProduct_evenCoefficient_eq_dotProduct
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRParityPrefix.parityExtractedMaskMatrix_uniform_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRParityPrefix.pairedEvenErrorVector_cbd_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRParityPrefix.extractParityKSKBatch_real
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRParityPrefix.parityPrefixAdvantage_eq_smallBinaryRLWE
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRParityPrefix.targetAdvantage_le_two_smallBinaryRLWE
#check FormalProof4FHE.TFHE.NativeTRGSWCVZRParityPrefix.cvzrOrdinaryRLWEReduction_advantage_eq_half

-- Native restricted quadratic KDM and the implementation-independent TFHE control length.
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.nativeNonceRow_eq_normalized
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.translateBRK_real
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.translateBRK_uniform_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.nonceKDMMessage_eq_sum
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.parityJoin_mul
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.assembleParityZeroRow_real
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.assembleParityZeroRow_uniform_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.aggregateNonceBody_eq_square
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.aggregateMask_uniform_evalDist_of_isUnit
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.ExactDirectSourceCompiler.reduction_advantage_eq_targetAdvantage
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.halfRingMatchSquareReduction_advantage_eq
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.halfRingSamplesPerView_rankOne
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.nativeRestrictedQuadraticKDMGap_le_halfRingRLWE
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.uniformBinaryControlConcentration
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.oneCoordinateControlConcentration_le_two
#check FormalProof4FHE.TFHE.NativeTRGSWQuadraticKDMAndTFHET.sqrt_sourceTerm_le_target

-- Hash-compressed complete-view reduction and the block-cycle alternative.
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.hasUniformOutput_of_surjectiveF2LinearHash
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.hashedPrefixLeakage_uniform_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.hashedPrefixConcentration_eq_card
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.hashedBinaryPrefixConcentration_eq_twoPow
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.binaryHashSquareRootLoss_sq
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.hashOnlyNativeGap_le
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.hashOnlyNativeGap_le_squareRootLoss
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.hashLossyDualModeNativeGap_le
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.no_short_uniformHash_phaseObliviousBuilder
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.blockCycleSecurity_le
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.exactPartitionBinaryBlockCycleSecurity_le
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.blockSourceRequirement_sufficient
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.perBlockSourceRequirement_powerOfTwoBlocks
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.vectorLWE_xorTransport_exact
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.vectorLWE_xorTransport_uniform_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWHashCompressedSecurity.nativeScalarAffineXorTransport_iff_constant

-- Hash-lossy complete-view theorem, translation barriers, and statistical decoder obstruction.
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.projectedLeakageConcentration_le_gamma
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.projectedLeakageGamma_eq_concentration_of_squareRootTilt
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.hashFiberLossyView_evalDist_eq_of_hash_eq
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.hashFiberResample_uniform_evalDist
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.lossyUniformPrefixView_evalDist_eq_ordinary
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.averagedConditionalDigestConcentration_eq_twoPow
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.averagedUniformBinaryDigestMatchSquareGap_le
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.digestMatchSquareGap_le_of_approximateErasure
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.uniformBinaryDigestMatchSquareGap_le_of_exactErasure
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.uniformBinaryHashLossyCompleteViewComposition_le
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.uniformBinaryHashLossyCompleteViewComposition_le_of_exactErasure
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.phaseObliviousHash_injective
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.prefixCard_le_digestCount_of_phaseOblivious
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.approximatePhaseObliviousHash_defect_lowerBound
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.hashFactorizedDecoderSuccess_eq_probability
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.hashFactorizedDecodingProbability_le_cardRatio
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.labelledDecoderSuccessGap_le_tvDist
#check FormalProof4FHE.TFHE.NativeTRGSWHashLossyCompleteView.binaryHashStatisticalModeSwitch_lowerBound_of_factorizedView

-- Synthesis of the conditional dual-mode theorem and the nonce-row factorization obstruction.
#check FormalProof4FHE.TFHE.NativeTRGSWProofDualMode.sourceIndependentConstructor_real_reference_evalDist_eq
#check FormalProof4FHE.TFHE.NativeTRGSWProofDualMode.target_tvDist_le_of_sourceIndependent_erasure
#check FormalProof4FHE.TFHE.NativeTRGSWProofDualMode.target_tvDist_le_of_sourceIndependentConstructor
#check FormalProof4FHE.TFHE.NativeTRGSWProofDualMode.completeAcceptanceHybrid_le
#check FormalProof4FHE.TFHE.NativeTRGSWProofDualMode.completeConditionalDigestComposition_le
#check FormalProof4FHE.TFHE.NativeTRGSWProofDualMode.averagedUniformBinaryCompleteDigestComposition_le
#check FormalProof4FHE.TFHE.NativeTRGSWProofDualMode.averagedUniformBinaryCompleteDigestComposition_le_of_exactErasure
#check FormalProof4FHE.TFHE.NativeTRGSWProofDualMode.averagedUniformBinaryCompleteDigestComposition_le_of_exactFidelityAndErasure
#check FormalProof4FHE.TFHE.NativeTRGSWProofDualMode.hiddenRank_nonceResidual_identity
#check FormalProof4FHE.TFHE.NativeTRGSWProofDualMode.factorizedHiddenRankResidual_add_nonceKDMMessage_not_factorsThroughDigest

-- Support-sensitive accounting and robust deterministic/stochastic leakage separation.
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateRobustLeakage.sum_lowSubsetFamily_supportBound_eq_binomial
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateRobustLeakage.diagonalGap_le_binomialSupportBounds_add_aggregate
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateRobustLeakage.supportSizeLowFrequencyBound_of_certificate
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateRobustLeakage.diagonalGap_le_affineCertificateSupportBounds_add_aggregate
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateRobustLeakage.diagonalGap_le_binomialSupportBounds_add_approximateAggregate
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateRobustLeakage.two_le_normalization_mul_sum_translationL1Defects
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateRobustLeakage.prefix_eq_of_equal_leakage_of_four_mul_normalization_mul_defect_lt_two
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateRobustLeakage.prefix_eq_of_shared_stochasticLeakageValue_of_small_pointwise_defect
#check FormalProof4FHE.TFHE.NativeTRGSWAggregateRobustLeakage.two_mul_stochasticLeakageOverlap_le_normalization_mul_averageDefects

-- Conditional hard-theorem composition and the remaining native-TRGSW research boundary.
#check FormalProof4FHE.TFHE.NativeTRGSWHardTheoremComposition.idealGap_le_two_mul_source_add_compilerDefects
#check FormalProof4FHE.TFHE.NativeTRGSWHardTheoremComposition.abs_signedHighDegreeSum_le_of_completeViewCompiler
#check FormalProof4FHE.TFHE.NativeTRGSWHardTheoremComposition.two_mul_aggregateNormalization_le_one_add_sqrt_card
#check FormalProof4FHE.TFHE.NativeTRGSWHardTheoremComposition.abs_signedHighDegreeSum_le_polynomialNormalization
#check FormalProof4FHE.TFHE.NativeTRGSWHardTheoremComposition.constrainedBatchCompiler_advantage_le
#check FormalProof4FHE.TFHE.NativeTRGSWHardTheoremComposition.scaledTernaryPreimages_yield_shortKernel
#check FormalProof4FHE.TFHE.NativeTRGSWHardTheoremComposition.card_mul_decoderSuccessMass_sq_le_halfRenyiJointMass_of_uniformPrefix
#check FormalProof4FHE.TFHE.NativeTRGSWHardTheoremComposition.card_mul_one_sub_failure_sq_le_halfRenyiJointMass_of_uniformPrefix
#check FormalProof4FHE.TFHE.NativeTRGSWHardTheoremComposition.hiddenModeComposition_advantage_le
#check FormalProof4FHE.TFHE.NativeTRGSWHardTheoremComposition.jointSecurity_le_supportSum_add_completeViewCompiler
#check FormalProof4FHE.TFHE.NativeTRGSWHardTheoremComposition.jointSecurity_le_supportSum_add_polynomialSourceLoss

-- Minimal complete-view assumptions for native self-key circular security.
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.affineTranslateRow_homogeneous
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.affineTranslateBatch_uniform_evalDist
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.affineTargetAdvantage_le_two_mul_sourceBound
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.nativeNonceRow_phase
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.aggregateNativeBodyRows_phase_linear
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.aggregateNegativeNativeNonceRows_phase_square
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.CoefficientProductExperiment.oneCircularAdvantage_le_correlation_add_independentZero
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.CoefficientProductExperiment.oneCircularHardAgainst_of_correlation_and_independentZero
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.CoefficientProductExperiment.oneCircularAdvantage_le_minimalCorrelation
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.SquareExperiment.circularAdvantage_le_squareCorrelation
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.SquareExperiment.ofCoefficientProjection_correlationAdvantage_eq
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.SquareExperiment.correlationHardAgainst_of_coefficientProjection
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.directOneCircularSecurity_le
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.minimalCorrelationSecurity_le
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.squareKeySecurity_le

-- Reusable three-game hybrid and its literal native cloud-key instantiation.
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.ThreeGameExperiment.circularAdvantage_le_correlation_add_independentZero
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.ThreeGameExperiment.standardEndpointHardAgainst_of_independentZero_and_zeroIdeal
#check FormalProof4FHE.TFHE.CircularSecurityMinimalAssumption.ThreeGameExperiment.security_le_correlation_add_standard_add_sampler
#check FormalProof4FHE.TFHE.NativeCircularSecurityInstantiation.nativeCloudKeyExperiment_selfSampler_eq_diagonalNativeView
#check FormalProof4FHE.TFHE.NativeCircularSecurityInstantiation.nativeCloudKeyExperiment_independentSampler_eq_independentMessageNativeView
#check FormalProof4FHE.TFHE.NativeCircularSecurityInstantiation.nativeCloudKeyExperiment_zeroSampler_eq_zeroMessageNativeView
#check FormalProof4FHE.TFHE.NativeCircularSecurityInstantiation.nativeCloudKeyExperiment_selfSampler_evalDist_eq_realCloudKeyView
#check FormalProof4FHE.TFHE.NativeCircularSecurityInstantiation.nativeCloudKeySecurity_le_correlation_add_standard
#check FormalProof4FHE.TFHE.NativeCircularSecurityInstantiation.nativeCompleteViewSecurity_le_correlation_add_standard
